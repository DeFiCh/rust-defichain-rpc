//! # defichain-rpc integration test
//!
...
use defichain_rpc::jsonrpc::error::Error as JsonRpcError;
...
impl log::Log for StdLogger {
    fn enabled(&self, metadata: &log::Metadata) -> bool {
        metadata.target().contains("jsonrpc") || metadata.target().contains("defichain_rpc")
    }
...
fn get_auth() -> defichain_rpc::Auth {
